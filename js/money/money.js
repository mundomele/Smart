...
money.updateCompliment = function () {
    ...
    $("#mostuncent td:nth-child(1)").html("0,01 €");
    ...
    $("#mostdoscent td:nth-child(1)").html("0,02 €");
    ...
    $("#mostcincocent td:nth-child(1)").html("0,05 €");
    ...
    $("#mostdiezcent td:nth-child(1)").html("0,1 €");
    ...
    $("#mostveintecent td:nth-child(1)").html("0,2 €");
    ...
    $("#mostcunccent td:nth-child(1)").html("0,5 €");
    ...
    $("#mostuneuro td:nth-child(1)").html("1 €");
    ...
    $("#mostdoseuro td:nth-child(1)").html("2 €");
